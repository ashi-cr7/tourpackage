    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='myweb_user_set', to='auth.group')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='myweb_user_permissions_set', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
